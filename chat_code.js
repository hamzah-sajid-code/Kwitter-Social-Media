...
//   nameofsender = message_data['name'];
//   message = message_data['message'];
//   like = message_data['like'];
//   name_with_tag = "<h4> " + nameofsender + " <img class='user_tick' src='tick.png'></h4>";
//   message_with_tag = "<h4 class='message_h4'> " + message + " </h4>";
//   like_button_with_tag = "<button class='btn btn-danger' value=" + like + " id=" + firebase_message_id + " onclick='updatelike(this.id)'>";
